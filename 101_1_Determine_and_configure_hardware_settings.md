...
/proc/sys/ # доступная для редактирования информация о системе
```
...
```ruby
/sys/devices/ # хранит все устройства зарегистрированные в системе
/sys/bus/ # перечень шин
/sys/drivers # драйверы
/sys/block # каталог блочных устройств
/sys/class # гурупировка устройств по классам
```
