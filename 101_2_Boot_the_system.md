...
1. [Инициализация операционной системы](#1)
2. [Проверки инициализации](#2)
3. [Резюме](#3)
...
## [[⬆]](#toc) <a name='1'>Инициализация операционной системы</a>
...
## [[⬆]](#toc) <a name='2'>Проверки инициализации</a>
...
### [[⬆]](#toc) <a name='3'>Резюме</a>
В этом уроке рассматривается последовательность загрузки в стандартной системе Linux. Правильное знание того, как работает процесс загрузки системы Linux, помогает предотвратить ошибки, которые могут сделать систему недоступной. Урок охватывает следующие темы:

* _Чем отличаются методы загрузки BIOS и UEFI_
* _Типичные этапы инициализации системы_.
* _Восстановление сообщений загрузки_.

Рассматривались следующие команды и процедуры:

* _Общие параметры ядра_.
* _Команды для чтения загрузочных сообщений: `dmesg` и `journalctl`_.
