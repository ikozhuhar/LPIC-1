...
## [[⬆]](#toc) <a name="1">Просмотреть информацию о процессоре</a>
`lscpu`, `less /proc/cpuinfo`, `lshw -class processor`


## [[⬆]](#toc) <a name="2">Просмотреть информацию о модулях оперативной памяти</a>
...
## [[⬆]](#toc) <a name="3">Определить модель жесткого диска</a>
...
## 5. [[⬆]](#toc) <a name="4">Вывести сведения обо всех платах расширения на шине PCIEx</a>
`lspci`
...
## [[⬆]](#toc) <a name="5">Отключить звуковую карту</a>
