...
## <a hraf="1">Просмотреть информацию о процессоре</a>
`lscpu`, `less /proc/cpuinfo`, `lshw -class processor`


## <a hraf="2">Просмотреть информацию о модулях оперативной памяти</a>
...
## <a hraf="3">Определить модель жесткого диска</a>
...
## <a hraf="4">Вывести сведения обо всех платах расширения на шине PCIEx</a>
`lspci`
...
## <a hraf="5">Отключить звуковую карту</a>
